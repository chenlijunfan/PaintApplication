package com.clj.paint.checkandcross.view;
...
import com.clj.paint.checkandcross.R;
import com.clj.paint.checkandcross.common.DisplayUtils;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

/**
 * Created by clj on 2017/12/29.
 */
...
public class CrossMarkView extends View {
    ...
    public CrossMarkView(Context context) {
        super(context);
        //init();
    }

    public CrossMarkView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CrossMarkView(Context context, AttributeSet attrs, int defStyle) {
    ...
    void init() {
        ...
        //设置画笔颜色
        paint.setColor(Color.parseColor("#10B703"));
